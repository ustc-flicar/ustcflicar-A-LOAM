...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pub_laser_cloud = n.advertise<sensor_msgs::PointCloud2>("/velodyne_points_HDL32", 2);
    ...
    while (std::getline(timestamp_file, line) && ros::ok())
    {
        ...
        if (to_bag)
        {
            ...
            bag_out.write("/velodyne_points_HDL32", ros::Time::now(), laser_cloud_msg);
